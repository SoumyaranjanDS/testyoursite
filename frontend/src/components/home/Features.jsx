...
const features = [
  {
    ...
    className: "md:col-span-2 bg-gray-50 dark:bg-[#121214] border border-gray-200 dark:border-white/5",
  },
  {
    icon: Shield,
    ...
    className: "md:col-span-1 bg-gray-50 dark:bg-[#121214] border border-gray-200 dark:border-white/5",
  },
  {
    icon: BrainCircuit,
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-medium text-gray-900 dark:text-milky mb-4 font-heading">
            Everything you need. <span className="text-gray-500 dark:text-gray-500">Nothing you don't.</span>
          </h2>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {features.map((feature, idx) => {
            ...
            return (
              ...
              >
                <div className="w-12 h-12 rounded-xl bg-white/5 border border-gray-200 dark:border-white/10 flex items-center justify-center mb-6 shadow-[inset_0_1px_0_rgba(255,255,255,0.1)]">
