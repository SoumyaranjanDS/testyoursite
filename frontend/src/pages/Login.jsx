      ...
      <div className="hidden lg:flex w-1/2 relative overflow-hidden bg-gray-50 dark:bg-[#121214] border-r border-gray-200 dark:border-white/5 flex-col justify-between p-12">
        ...
        <div className="relative z-10 max-w-md">
          ...
          <h2 className="text-4xl font-medium text-gray-900 dark:text-white mb-6 leading-tight">
            Diagnose bottlenecks before your users do.
          </h2>
          <p className="text-gray-600 dark:text-gray-400 text-lg leading-relaxed mb-8">
            Connect your infrastructure and run high-concurrency load tests with AI-powered root cause analysis in minutes.
          </p>
          
          <div className="grid grid-cols-2 gap-4">
             <div className="bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl p-4">
                <Terminal className="w-6 h-6 text-indigo-400 mb-2" />
                <h3 className="text-gray-900 dark:text-white font-medium mb-1">Agentless</h3>
                <p className="text-gray-500 dark:text-gray-500 text-sm">No installations required</p>
             </div>
             <div className="bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl p-4">
                <Activity className="w-6 h-6 text-green-400 mb-2" />
                <h3 className="text-gray-900 dark:text-white font-medium mb-1">Real-time</h3>
                <p className="text-gray-500 dark:text-gray-500 text-sm">Live metric correlation</p>
             </div>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 relative">
        ...
        <div className="w-full max-w-md">
          <div className="text-center lg:text-left mb-10">
            <h2 className="text-3xl font-semibold text-gray-900 dark:text-white mb-3">Welcome back</h2>
          ...
          <div className="flex items-center gap-4 mb-6">
            ...
            <span className="text-gray-500 dark:text-gray-500 text-sm">or sign in with email</span>
            <div className="h-px bg-white/10 flex-1"></div>
          </div>
          ...
          <form className="space-y-5" onSubmit={(e) => { e.preventDefault(); console.log('Login submitted'); }}>
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <a href="#" className="text-sm text-[#6366f1] hover:text-[#4f46e5] transition-colors">Forgot password?</a>
              </div>
              <input 
                type="password" 
                placeholder="••••••••"
          ...
          <div className="mt-8 text-center text-gray-600 dark:text-gray-400">
            Don't have an account? <Link to="/signup" className="text-gray-900 dark:text-white hover:text-[#6366f1] font-medium transition-colors">Sign up</Link>
          </div>
        </div>
      </div>
    </div>
